...
export const CONSTANTS = {
    ...
    I_CACHE_SIZE: 8,
    D_CACHE_SIZE: 16,
    MAX_THREADS: 8, // limite maximo de threads globais (4 cores x 2 threads)
    THREADS_PER_CORE: 2, // quantidade de threads por core
    INSTRUCTION_MAP: {
...
// mapa reverso para buscar a string da instrucao pelo opcode
